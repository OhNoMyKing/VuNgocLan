...
function ModuleModalUpdateSportswear({ sportswear }) {
  ...
  const handleFileChange = (event) => {
    ...
    Promise.all(promises).then((base64Files) => {
      ...
      setSportswearUpdate({
        ...sportswearUpdate,
        list_of_related_sportswear_images: base64Files,
      });
    });
  };
  ...
  const deleteByID = async (event) => {
    ...
    if (confirmDelete) {
      try {
        ...
        const response = await SportswearService.deleteSportswearByID(
          token,
          sportswearUpdate.id
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await SportswearService.addSportswear(
        token,
        sportswearUpdate
      );
      if (response.message === "oke") {
    ...
    <div>
      <div>
        <button
          ...
          data-toggle="modal"
          data-target={`#updateModal_${sportswear.id}`}
        >
          <strong>
                ...
                <div className="card-body">
                  ...
                  >
                    <div className="d-flex main-content">
                      <div
                        className="bg-image promo-img mr-3"
                        style={{
                          backgroundImage: `url(${sportswear.main_image})`,
                        }}
                      ></div>
                      ...
                      <div className="content-text row">
                        ...
                        <form onSubmit={handleSubmit} className="col-12">
                            ...
                            <div className="input-select">
                              ...
                              >
                                ...
                                <option
                                  value="Jeseys"
                                  selected={
                                    sportswearUpdate.categoryName === "Jeseys"
                                  }
                                >
                                  Áo câu lạc bộ
                                </option>
                                ...
                                <option
                                  value="Fashion"
                                  selected={
                                    sportswearUpdate.categoryName === "Fashion"
                                  }
                                >
                                  Thời trang khác
                                </option>
                          ...
                          <div className="d-flex align-items-center justify-content-between mb-4">
                            <div className="form-check">
                              <input
                                ...
                                checked={sportswearUpdate.status === 1}
                                onChange={handleStatusChange}
                              />
                              <label
                                className="form-check-label text-dark"
                                for="availableCheckbox"
                              >
                                Có sẵn
                              </label>
                            </div>
                          ...
                          <div className="d-flex align-items-center justify-content-between mb-4">
                            <div className="form-check">
                              <input
                                ...
                                value=""
                                id="disableCheckbox"
                                checked={sportswearUpdate.status === 0}
                                onChange={handleStatusChange}
                              />
                              <label
                                className="form-check-label text-dark"
                          ...
                          <div className="form-group">
                            ...
                            />
                            <ul>
                              {sportswearUpdate.list_of_related_sportswear_images?.map(
                                (base64Image, index) => (
                                  <li
                                    key={index}
                                    style={{
