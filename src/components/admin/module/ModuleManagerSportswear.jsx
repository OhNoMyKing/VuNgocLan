                                                        ...
                                                        <div className="media align-items-center align-items-lg-start  text-lg-left flex-column flex-lg-row">
                                                            ...
                                                            <div className="media-body">
                                                                ...
                                                                <ul className="list-inline list-inline-dotted mb-3 mb-lg-2">
                                                                    <li className="list-inline-item text-danger">Trạng thái :</li>
                                                                ...
                                                                <ul className="list-inline list-inline-dotted mb-3 mb-lg-2">
                                                                    <li className="list-inline-item text-danger">Số lượng còn lại:</li>
                                                            ...
                                                            <div className="mt-3 mt-lg-0 ml-lg-3 text-center">
                                                                ...
                                                                <ModuleModalUpdateSportswear sportswear={item} />
                                                                <ModuleStatisticalSportswear sportswear={item} />
