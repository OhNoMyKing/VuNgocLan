                    ...
                    <div className="row justify-content-center w-100">
                                ...
                                <div className="card-body" >
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value={username} onChange={(e) => setUsername(e.target.value)} required />
                                        </div>
                                        <div className="mb-4">
                        ...
                        <label className="form-check-label text-dark" for="flexCheckChecked">
                          Remeber this Device
                                        ...
                                        <button type="submit" className="btn btn-primary m-1">Đăng ký</button>
                                        <div className="d-flex align-items-center justify-content-center">
                                            <p className="fs-4 mb-0 fw-bold">Hehe tôi đã có tài khoản rồi</p>
                                            <a className="text-primary fw-bold ms-2" href="/login">Đăng nhập</a>
                                        </div>
                                    </form>
