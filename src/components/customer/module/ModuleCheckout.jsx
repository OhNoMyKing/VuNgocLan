                                    ...
                                    <div class="col-md-12">
                                        <div class="cart-detail">
                                            ...
                                            <ul>
                                                ...
                                                <h6 className="fw-semibold mb-1 text-warning">Thành tiền giỏ hàng</h6>
                                                <strong><li>Tổng : {formatter.format(checkoutResponse.totalAmount)} ({checkoutResponse.totalQuantity} vật phẩm)</li></strong>
                                                ...
                                                <div className="card card-body" key={item.id} style={{ marginTop: '10px' }}>
                                                    <div className="media align-items-center align-items-lg-start  text-lg-left flex-column flex-lg-row">
                                                        ...
                                                        <div className="media-body">
                                                            ...
                                                            <ul className="list-inline list-inline-dotted mb-3 mb-lg-2">
                                                                <li className="list-inline-item text-secondary"><strong>Số lượng :</strong></li>
                                                        ...
                                                        <div className="mt-3 mt-lg-0 ml-lg-3 text-center">
                                                            ...
                                                            <div className="text-success"><h5><strong className="text-danger">{formatter.format(item.price)} </strong> <span className="text-dark">x {item.quantity}</span></h5></div>
                                                ...
                                                <thead className="text-dark fs-4">
                                                    <tr>
                                                        ...
                                                        <th className="border-bottom-0">
                                                            <h6 className="fw-semibold mb-0">Tổng giỏ hàng</h6>
                                                        </th>
                                                        <th className="border-bottom-0">
                                                            <h6 className="fw-semibold mb-0">Phí vận chuyển</h6>
                                                        </th>

                                                        <th className="border-bottom-0">
                                                            <h6 className="fw-semibold mb-0">Số tiền thanh toán</h6>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td className="border-bottom-0">
                                                            <h6 className="fw-semibold mb-1">{formatter.format(checkoutResponse.totalAmount)}</h6>

                                                        </td>

                                                        <td className="border-bottom-0">
                                                            <div className="d-flex align-items-center gap-2">
                                                                <span className="badge bg-primary rounded-3 fw-semibold">{formatter.format(shippingFee)}</span>
                                                            </div>
                                                        </td>
                                                        <td className="border-bottom-0">
                                                            <h6 className="fw-semibold mb-0 fs-4">{formatter.format(checkoutResponse.totalAmount + shippingFee)}</h6>
                                                        </td>
                                                    </tr>
